...
import { Terminal, Mail, Lock, User, Image, ArrowRight } from "lucide-react";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await signUp.email({
                ...
                password,
                name,
                image: photoUrl || `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(name)}`,
                callbackURL: "/"
            }, {
            ...
            <div className="max-w-md w-full space-y-8 z-10">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-zinc-400">
                        Join PromptSphere to start sharing and discovering AI prompts
                    </p>
                </div>
